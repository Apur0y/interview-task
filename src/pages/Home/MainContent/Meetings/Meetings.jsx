...
const Meetings = () => {
    ...
    return (
        <div className='text-black p-5 shadow-lg rounded-lg'>
                ...
                <tbody className='overflow-auto'>
                    {
                      ...
                      <td className='border-b-2 border-gray-300 w-32 py-2'>{data.date}</td>
                              <td className='border-b-2 border-gray-300 px-4 py-2'>{data.status}</td>
                                <td className='border-b-2 border-gray-300 w-32 px-4 py-2'>{data.priority}</td>
